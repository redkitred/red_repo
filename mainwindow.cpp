...
//--------------------------------
	...
	this->setWindowTitle("ModBus Red");
...
//	pollbool =!pollbool;
//	if(pollbool)
//		ui->res_lineEdit->setText("1");
//	else ui->res_lineEdit->setText("0");
}
...
//		qDebug() << "CRC:" << CRC;
		...
		else if(receivedData.length() != (ByteCount.toUInt(&ok,16)*2))	gs_ucErrortReg = ILLEGAL_DATA_ERR;
//		else if(serial->error())										gs_ucErrortReg = ACKNOWLEDGE_ERR;
		else if(1 == function)											gs_ucErrortReg = ASCII_READ_COILS;
		else if(2 == function)											gs_ucErrortReg = ASCII_READ_DIS_IN;
		else if(3 == function)											gs_ucErrortReg = ASCII_READ_HOLD_REG;
		else if(4 == function)											gs_ucErrortReg = ASCII_IN_REG;
//		else if(5 == function)											gs_ucErrortReg = ASCII_WRITE_EEPROM;
//		else if(6 == function)											gs_ucErrortReg = ASCII_WRITE_EEPROM;
